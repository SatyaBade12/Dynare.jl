...
quantile(d::InverseGamma1, p::Real) = sqrt(quantile(InverseGamma(d.α, d.θ), p))
cquantile(d::InverseGamma1, p::Real) = sqrt(cquantile(InverseGamma(d.α, d.θ), p))
invlogcdf(d::InverseGamma1, p::Real) = sqrt(invlogcdf(InverseGamma(d.α, d.θ), p))
invlogccdf(d::InverseGamma1, p::Real) = sqrt(invlogccdf(InverseGamma(d.α, d.θ), p))
